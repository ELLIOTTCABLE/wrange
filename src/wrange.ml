...
let parse_buf_exn lexbuf = Parser.doc Lexer.read lexbuf
...
let parse_exn str = parse_buf_exn (Lexing.from_string str)

let parse_print_errors str = parse_buf_print_errors (Lexing.from_string str)
